...
export function initHeroScrollAnimation() {
  ...
  function drawFrame(index) {
    ...
    if (isMobile) {
      // Mobile: Centered capsule video framing cleanly between header buttons and lower slide stage
      const maxDrawHeight = canvasHeight * 0.35;
      ...
      drawY = canvasHeight * 0.28; // Centered capsule video framing!
    } else {
